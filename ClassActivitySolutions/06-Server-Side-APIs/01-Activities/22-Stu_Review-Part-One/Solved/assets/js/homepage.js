...
var buttonClickHandler = function (event) {
  ...
  // if there is a language, then fetch it
  if (language) {
    getFeaturedRepos(language); // this process happens in the background and moves on to line 30
    console.log("clear out the data before getting the new data.") 
    repoContainerEl.textContent = ''; // clear out the data 
  }
